...
fbq.registerPlugin('408233920546922', {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    fbq.loadPlugin('inferredevents');
    fbq.loadPlugin('identity');
    instance.optIn('408233920546922', 'InferredEvents', true);
    fbq.loadPlugin('jsonld_microdata');
    instance.optIn('408233920546922', 'MicrodataJsonLd', true);
    fbq.loadPlugin('iwlbootstrapper');
    instance.optIn('408233920546922', 'IWLBootstrapper', true);
    fbq.loadPlugin('iwlparameters');
    fbq.loadPlugin('inferredevents');
    instance.optIn('408233920546922', 'IWLParameters', true);
    fbq.set('iwlExtractors', '408233920546922', []);
    fbq.loadPlugin('cookie');
    instance.optIn('408233920546922', 'FirstPartyCookies', true);
    fbq.loadPlugin('inferredevents');
    fbq.loadPlugin('microdata');
    fbq.loadPlugin('identity');
    instance.optIn('408233920546922', 'AutomaticSetup', true);
    ...
    config.set('408233920546922', 'prohibitedSources', {
      prohibitedSources: [],
    });
    fbq.loadPlugin('prohibitedsources');
    instance.optIn('408233920546922', 'ProhibitedSources', true);
    config.set('408233920546922', 'unwantedData', {
      blacklisted_keys: {},
      sensitive_keys: null,
    });
    fbq.loadPlugin('unwanteddata');
    instance.optIn('408233920546922', 'UnwantedData', true);
    fbq.loadPlugin('iabpcmaebridge');
    instance.optIn('408233920546922', 'IABPCMAEBridge', true);
    instance.configLoaded('408233920546922');
  },
});
